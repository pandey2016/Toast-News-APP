...
public class IndiaTvNews extends AppCompatActivity {
    ArrayList<NewsItem> newsItemList;
    private LinearLayoutManager lLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_india_tv_news);
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                progress.cancel();
                Toast.makeText(IndiaTvNews.this, "loading...", Toast.LENGTH_SHORT).show();
            }
        };
        ...
        StringRequest request =new StringRequest("http://www.indiatvnews.com/rssfeed/india.xml", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                for(int i=0;i<itemElements.size();i++){
                    ...
                    String description=removeCdata(item.child(3).text());
                ...
                //Recycler View
                lLayout = new LinearLayoutManager(IndiaTvNews.this);
                RecyclerView rView = (RecyclerView)findViewById(R.id.recycler_view);
                rView.setLayoutManager(lLayout);
                RecyclerViewAdapter rcAdapter = new RecyclerViewAdapter(IndiaTvNews.this, newsItemList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(IndiaTvNews.this, "Request Error", Toast.LENGTH_SHORT).show();
            }
        });
        queue.add(request);
