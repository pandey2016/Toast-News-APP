...
public class OneIndiaNews extends AppCompatActivity {
    ArrayList<NewsItem> newsItemList;
    private LinearLayoutManager lLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_one_india_news);
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                progress.cancel();
                Toast.makeText(OneIndiaNews.this, "loading...", Toast.LENGTH_SHORT).show();
            }
        };
        ...
        StringRequest request =new StringRequest("http://www.oneindia.com/rss/news-india-fb.xml", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                //Recycler View
                lLayout = new LinearLayoutManager(OneIndiaNews.this);
                RecyclerView rView = (RecyclerView)findViewById(R.id.recycler_view);
                rView.setLayoutManager(lLayout);
                RecyclerViewAdapter rcAdapter = new RecyclerViewAdapter(OneIndiaNews.this, newsItemList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(OneIndiaNews.this, "Request Error", Toast.LENGTH_SHORT).show();
            }
        });
        queue.add(request);
